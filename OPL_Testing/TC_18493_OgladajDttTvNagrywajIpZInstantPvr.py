...
class TC_18493_OgladajDttTvNagrywajIpZInstantPvr(TC_OPL_template):

    """Implementation of the HP QC test ID 18493_OgladajDttTvNagrywajIpZGuidePvr
    ...
    def test(self):
        try:
            ...
            time.sleep(3)
            self.assertTrue(self.page.actionInstantRecord(5),'ERR in actionInstantRecord')
            time.sleep(5)
