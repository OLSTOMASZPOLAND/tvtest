...
class TC_18497_T999999_002_PVR(TC_OPL_template):
    '''Implementation of the HP QC test ID - 18497 - _TC_T099999 - W&R z TS. najpierw live na kanale 1, instant PVR na kanale 1
    ...
    def test(self):
        try:
            ...
            self.assertTrue(self.page.actionSelect(Menu.pvrYes), "   ERR   cannot select {}".format(Menu.pvrYes))
