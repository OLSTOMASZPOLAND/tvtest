...
class TC_18534_T999999_039(TC_OPL_template):
    '''Implementation of the HP QC test ID - 18534 - T999999 W&R bez TS na kanale 1 LIVE - UHD86
    ...
    def test(self):
        try:
            ...
            ''' step '''
            self.logStepBeginning("Set schedule record on channel 1")
            ...
            self.assertFalse(self.page.checkLive(), "   ERR   live not detected")

            self.logStepResults("Set schedule record on channel 1")
