...
class TC_3341_T014472_modify_confidential_code_set_it_to_code_to_0000(TC_OPL_template):
    '''Implementation of the HP QC test ID - 3341  -  T014472_modify_confidential_code_set_it_to_code_to_0000
    ...
    def test(self):
        ...
        try:
            ...
            self.assertTrue(self.page.actionSelect(Menu.parentalCode), "   ERR   cannot find parent codes")
            time.sleep(5)
            ...
            self.assertTrue(self.page.findInDialogBox(DialogBox.WrongNewParentalCode0000), "   ERR   no error message about code 0000 not allowed")
            ...
            self.assertFalse(self.page.rentVodThenPlay(True, True), "   ERR:   vod rented with previous parental code")
