...
class TC_3342_T014473_modify_confidential_code_error_with_new_code_confirmation(TC_OPL_template):
    '''Implementation of the HP QC test ID - 3342  -  T014473_modify_confidential_code_error_with_new_code_confirmation
    ...
    def test(self):
        ...
        try:
            ...
            self.assertTrue(self.page.findInDialogBox(DialogBox.ConfidentialCodeMismatch), "   ERR   no error message about codes mismatch")
