...
class TC_3385_T014537_Set_the_default_subtitle_polish_VOD(TC_OPL_template):
    '''
    Coverage: HP QC test ID - 3385 - T014537_Set the default subtitle - polish - VOD
    ...
    def test(self):
        ...
        try:
            ...
            self.assertTrue(self.page.actionSelect(Menu.nativeSubtitles), "ERR: Choosing 'polskie' option in 'napisy' menu") 
            ...
            self.assertTrue(self.page.findInList(Menu.toolboxNativeSubtitle), "ERR: Problem checking if subtitles in VOD toolbox have changed")
            time.sleep(2)
