...
class TC_3404_Consult_the_legal_notices_from_my_account_my_preferences_in_opt_out(TC_OPL_template):
    """
    ...
    def test(self):
        try:
            ...
            time.sleep(2)
            assertTrue(self.page.findInPage(Description.IsDeactivatedRecommendation),"ERR in find >"+Description.IsDeactivatedRecommendation+"<")
            time.sleep(5)
