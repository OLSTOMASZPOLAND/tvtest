...
class TC_3421_T015655_set_the_green_parameter_activate_End_to_End_test_update(TC_OPL_template):
    '''Implementation of the HP QC test ID - 3421- _set_the_green_parameter_active_End_to_End_test_update
    ...
    def test(self):
        ...
        try:
            ...
            item = self.page.actionScheduleRecord(8, start, 30)
