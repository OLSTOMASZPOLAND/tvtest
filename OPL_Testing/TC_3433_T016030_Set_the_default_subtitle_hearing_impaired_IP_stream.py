...
class TC_3433_T016030_Set_the_default_subtitle_hearing_impaired_IP_stream(TC_OPL_template):
    '''
    Coverage: HP QC test ID - 3433 - T016030_Set the default subtitle - hearing impaired - IP stream
