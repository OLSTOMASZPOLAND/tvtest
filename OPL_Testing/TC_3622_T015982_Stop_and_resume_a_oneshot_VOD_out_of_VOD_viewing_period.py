...
class TC_3622_T015982_Stop_and_resume_a_oneshot_VOD_out_of_VOD_viewing_period(TC_OPL_template):

    """Implementation of the HP QC test ID TC_3622_T015982_Stop_and_resume_a_oneshot_VOD_out_of_VOD_viewing_period
...
'''
        ...
        while i!=30:
            time.sleep(10)
            try:
                self.page.checkLive(pvrAndVod=True)
            except False:
                i=30
            except True:
                time.sleep(2)
