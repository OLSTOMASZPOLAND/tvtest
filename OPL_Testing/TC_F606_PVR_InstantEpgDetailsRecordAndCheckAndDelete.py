...
class TC_F606_PVR_InstantEpgDetailsRecordAndCheckAndDelete(TC_OPL_template):
    """Launch Instant recording from EPG - Record menu item on EPG details screen; check record during recording; finally delete record
