...
class TC_F607_PVR_FutureEpgRecordAndCheckAndDelete(TC_OPL_template):
    """Implementation of the HP QC test ID - 9728 - T016360_Schedule a record - EPG programming; Schedule Future recording from EPG - Record key on EPG mosaic; check record during recording; finally delete record
